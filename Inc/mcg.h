...
#define SYSTEM_CLOCK				CORE_CLOCK				//System Clock / OUTDIV1(1)
#define BUS_CLOCK						SYSTEM_CLOCK / 2	//System Clock / OUTDIV4(2)

#define PLL0_PRDIV						4					// divider reference by 4 = 2 MHz
